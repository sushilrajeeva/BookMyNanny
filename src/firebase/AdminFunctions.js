...
const getVerifiedNannies = async () => {
    try {
      ...
      console.log(error);
      console.error(
        "Error getting verified nannies",
        error
      );
...
const getPendingVerifications = async () => {
    try {
      console.log("Get the list of nannies with pending verifications firestore method called");
      const NanniesCollection = collection(db, "Nanny");
      const NanniesSnapshot = await getDocs(NanniesCollection);
      ...
      console.log(error);
      console.error(
        "Error getting nannies to be verified",
        error
      );
      throw new Error("Error getting nannies");
    }
...
const VerifyNanny = async (nannyId) => {
  ...
  export { getVerifiedNannies,
    getPendingVerifications, VerifyNanny };