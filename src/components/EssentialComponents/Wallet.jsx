...
// Importing my custom created loading animaiton
...
export function Wallet() {
    ...
    // calling my custom  useWalletBalance hook to get balance of the loggedin parent user
    const { totalBalance, loading, error } = useWalletBalance(currentUser.uid)
    ...
    const makePayment = async() =>{
        ...
        console.log("Am i ever called", session);

        const result = await stripe.redirectToCheckout({
            sessionId: session.id
        })
        console.log("hmmm interesting", result);
        if(result.error){
