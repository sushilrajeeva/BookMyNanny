const exportedMethods = {
  description: "This is my helper function for form validations",

  // Validatoin for country code
  isValidCountry(country) {
    ...
    for (let i = 0; i < this.countryCodes.length; i++) {
      if (
        ...
        this.countryCodes[i].name.toLowerCase().trim()
      ) {
        return country;
      }
    }
  ...
  // To find country based on the country code
